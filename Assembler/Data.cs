...
namespace IkarosAssembler
{
    public class Data
    {
        ...
        private static readonly InstructionOpcode[] _instructionOpcodes = new InstructionOpcode[]
        {
            ...
            new("JEQZ_REG_REG", 0x74, 1),
            new("JEQZ_REG_IMM", 0x75, 2),
            new("JNEQ_REG_REG_IMM", 0x76, 2),
            new("JNEQZ_REG_REG", 0x77, 1),
            new("JNEQZ_REG_IMM", 0x78, 2),
            new("JF_FLAG_REG", 0x79, 1),
            ...
            new("JLZ_REG_REG", 0x84, 1),
            new("JLZ_REG_IMM", 0x85, 2),
            new("JGE_REG_REG_IMM", 0x86, 2),
            new("JGEZ_REG_REG", 0x87, 1),
            new("JGEZ_REG_IMM", 0x88, 2),
